...
class RMSNorm(torch.nn.Module):
    ...
    def _norm(self, x):
        ...
        """
        rms_reciprocal = torch.rsqrt(x.pow(2).mean(-1, keepdim=True) + self.eps)
...
class Attention(nn.Module):
    ...
    def compute_query_key_value_scores(self,
        ...
        # Compute the context by weighing the values with attention probabilities
...
class LlamaLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        # Apply layer normalization to the self-attention output
    ...
    def generate(self, idx, max_new_tokens, temperature=1.0):
        ...
        for _ in range(max_new_tokens):
            ...
            if temperature == 0.0:
                ...
                logits /= temperature
                # Obtain probabilities and sample the next token
